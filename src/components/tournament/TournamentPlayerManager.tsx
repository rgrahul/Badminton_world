          ...
          {dialogMode === "excel" && (
            <div className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground">
                ...
                <p>Optional: email, mobileNumber, age, gender (MALE/FEMALE), experience (or yearsOfExperience), lastPlayed, keyStrength, skillCategory (or skillRating/rating/level)</p>
