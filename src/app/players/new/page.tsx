      ...
      <main className="container mx-auto px-4 py-4 sm:py-8 max-w-2xl">
        <Card className="border-2 border-green-200 shadow-2xl">
          <CardHeader className="bg-gradient-to-r from-green-50 to-blue-50">
            ...
            <CardDescription className="text-sm sm:text-base text-gray-600 font-medium">Create a new player profile</CardDescription>
          </CardHeader>
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-3 pt-4">
                <Button type="button" variant="outline" onClick={() => router.push("/players")} className="flex-1 border-2 hover:bg-gray-50 font-semibold">
                  ❌ Cancel
                </Button>
